...
exports.seed = function(knex, Promise) {
  ...
  return knex('users').del()
    .then(function () {
      ...
      { email:'crys.tate@icloud.com', password_digest:require('bcryptjs').hashSync('password', 10), username: 'hiii', current_lat:30.698733, current_lng:-98.034149,home_address:'', home_lat:30.260834 , home_lng:-97.776852 , work_lat:30.297783 , work_lng:-97.753880},
